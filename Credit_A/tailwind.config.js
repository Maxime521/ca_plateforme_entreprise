...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary brand colors (inspired by Crédit Agricole)
        primary: {
        ...
        // Secondary colors (inspired by Wise.com)
        secondary: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
        ...
        error: {
          ...
          600: '#dc2626',
          700: '#b91c1c',
          800: '#991b1b',  // Added missing shade
          900: '#7f1d1d',  // Added missing shade
        },
        // Dark mode optimized
        dark: {
          bg: '#0f172a',
      ...
      boxShadow: {
        ...
        'financial': '0 10px 15px -3px rgba(20, 184, 166, 0.1), 0 4px 6px -2px rgba(20, 184, 166, 0.05)',
        'glow': '0 0 20px rgba(20, 184, 166, 0.3)',
        '2xl': '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
        '3xl': '0 35px 60px -12px rgba(0, 0, 0, 0.35)',
        'floating': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
        'floating-hover': '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
      },
      animation: {
