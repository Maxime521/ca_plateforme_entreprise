// tailwind.config.js - Improved Professional Design
...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Professional color palette: Black, White, Dark Green, Red accents
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      boxShadow: {
        ...
        'professional-lg': '0 10px 40px rgba(0, 0, 0, 0.12)',
      },
      backgroundImage: {
