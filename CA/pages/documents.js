//==============================================================================
// pages/documents.js - Updated with role-based access (users can view)
//==============================================================================
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-200">
              {isAdmin 
                ...
                : "Consultez les documents officiels des entreprises"
              }
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 dark:text-blue-400">
                  Vous pouvez consulter et rechercher dans les documents, mais l'importation et la gestion avancée sont réservées aux administrateurs.
                </p>
              </div>
            </div>
          </div>
...
// Enhanced Document Card with role awareness
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Admin-only edit indicator */}
          {isAdmin && (
            <span className="text-yellow-500" title="Accès admin">👑</span>
          )}
        </div>
      </div>
