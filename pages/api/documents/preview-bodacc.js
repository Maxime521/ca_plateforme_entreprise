// pages/api/documents/preview-bodacc.js - Direct BODACC preview endpoint
export default async function handler(req, res) {
  ...
  try {
    console.log(`📰 Direct BODACC HTML preview request for SIREN: ${siren}`);
    ...
    console.error('❌ Direct BODACC preview error:', error);
